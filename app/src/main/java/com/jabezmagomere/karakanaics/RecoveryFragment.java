...
import com.jabezmagomere.karakanaics.Adapter.CustomInfoWindowAdapter;
import com.jabezmagomere.karakanaics.Adapter.RecoveryAdapter;
 ...
 */
public class RecoveryFragment extends Fragment implements OnMapReadyCallback {
    MapView mapView;
    private GoogleMap map;
    private LocationListener locationListener;
    private LocationManager locationManager;
    private RequestQueue requestQueue;
    private static final String SOS_URL ="https://karakana.herokuapp.com/api/AllRecoveries";
    ...
    private List<Recovery> recoveryList=new ArrayList<>();
    private List<MyMechanic> myMechanicList=new ArrayList<>();
    String fName;
    String phoneNumber;
    Button btnRequestSOS;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnRequestSOS=(Button)view.findViewById(R.id.btnRequestRecovery);
        ...
        recoveryAdapter=new RecoveryAdapter(recoveryList);
    ...
    public void onMapReady(final GoogleMap googleMap) {
        ...
        try {
            boolean success = googleMap.setMapStyle(MapStyleOptions.loadRawResourceStyle(getContext(), R.raw.map_style1));
            if (!success) {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            for(int i=0;i<jsonArray.length();i++){
                                ...
                                Recovery recovery=new Recovery(jsonObject.getString("RecoveryName"),jsonObject.getString("PhoneNumber"),jsonObject.getString("Email"),jsonObject.getString("PhotoURL"),jsonObject.getString("Rating"),jsonObject.getString("Location"));
                                ...
                                MarkerOptions markerOptions=new MarkerOptions().position(RecoveryLocation).icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_sos));
                                Marker marker=googleMap.addMarker(markerOptions);
                                marker.setTag(recovery);
                                MyMechanic myMechanic=new MyMechanic(jsonObject.getString("RecoveryName"),jsonObject.getString("PhoneNumber"),RecoveryLocation);
                                myMechanicList.add(myMechanic);
                                googleMap.setInfoWindowAdapter(new CustomInfoWindowAdapter(getContext()));
                                CameraPosition cameraPosition=new CameraPosition.Builder().target(RecoveryLocation).zoom(9).build();
                                googleMap.animateCamera(CameraUpdateFactory.newCameraPosition(cameraPosition));
                            }
    ...
    public void distanceFormulae(Location location, List<MyMechanic> locationList){
        ...
        if(status){
            ...
            sweetAlertDialog.setTitle("The nearest recovery is");
            ...
            sweetAlertDialog.setContentText("No Recovery Located");
            sweetAlertDialog.show();
        }
